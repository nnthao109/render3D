...
def render (
    ...
    return render_3d(local_path="./ImageToStl.com_unicorn.obj",
            render_dir=render_dir,
            num_renders=num_renders,
            only_northern_hemisphere=only_northern_hemisphere,
...
# bash -c export DISPLAY=:0.0 && blender-3.2.2-linux-x64/blender --background --python blender_script.py -- --object_path './HMS Unicorn/Unicorn.blend' --num_renders 12 --output_dir /tmp/tmprwofb_lq/0fde27a0-99f0-5029-8e20-be9b8ecabb59 --engine BLENDER_EEVEE